...
public class Php extends AppCompatActivity implements OnListViewClick{

    ImageView fab;
    ListView Php_list;
    ArrayList<Url> urlsList = new ArrayList<>();
    ArrayList<Integer> arrayListCount = new ArrayList<>();
    DatabaseReference databasePhp =  FirebaseDatabase.getInstance().getReference().child(AddPhpUrl.DATBASE_NAME);
    CAdapter cAdapter;
    EditText searchphp;
    ...
    void onStartMethod(){
        databasePhp.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                cAdapter=new CAdapter(urlsList,Php.this, onListViewClick);

                Php_list.setAdapter(cAdapter);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab = findViewById(R.id.addPhp);
        Php_list=findViewById(R.id.list_php);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /*Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();*/
                Intent intent = new Intent(Php.this, AddPhpUrl.class);
                startActivityForResult(intent, 102);
            }
        });

        searchphp = findViewById(R.id.searchPhp);
        searchphp.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence cs, int start, int count, int after) {
                ...
                cAdapter = new CAdapter(tempArrayList, Php.this, onListViewClick);
                Php_list.setAdapter(cAdapter);
    ...
    public void onLisViewClick(View view, int position) {
        ...
        if (cnt >2){
            ...
            try {
                ...
                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(Php.this, "Rating is : " + value, Toast.LENGTH_LONG).show();
                    }
                });
            ...
            Toast.makeText(Php.this, "Count"+cnt, Toast.LENGTH_SHORT).show();
