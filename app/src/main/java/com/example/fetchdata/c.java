...
public class c extends AppCompatActivity implements OnListViewClick {

    ListView c_list;
    ImageView fab;
    ArrayList<Url> urlsList = new ArrayList<>();
    ArrayList<Integer> arrayListCount = new ArrayList<>();
    DatabaseReference database =  FirebaseDatabase.getInstance().getReference().child(AddUrl.DATBASE_NAME);
    CAdapter cAdapter;
    EditText search;
    ...
    void onStartMethod(){
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                cAdapter=new CAdapter(urlsList,c.this, onListViewClick);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c_list=findViewById(R.id.list_c);
...
//                        .setAction("Action", null).show();
                Intent intent=new Intent(c.this,AddUrl.class);
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence cs, int start, int count, int after) {
                ...
                cAdapter = new CAdapter( tempArrayList,c.this, onListViewClick);
                c_list.setAdapter(cAdapter);
   ...
   //             c_list.setAdapter(cAdapter);
    ...
    public void onLisViewClick(View view, int position) {
        ...
        if (cnt >2){
            ...
            try {
                ...
                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(c.this, "Rating is : " + value, Toast.LENGTH_LONG).show();
                    }
                });
            ...
            Toast.makeText(c.this, "Count"+cnt, Toast.LENGTH_SHORT).show();
