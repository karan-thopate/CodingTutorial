...
public class CoreJava extends AppCompatActivity implements OnListViewClick{
    ImageView fab;
    ListView Corejava_list;
    ArrayList<Url> urlsList = new ArrayList<>();
    ArrayList<Integer> arrayListCount = new ArrayList<>();
    DatabaseReference databaseCorejava =  FirebaseDatabase.getInstance().getReference().child(AddCoreJavaUrl.DATBASE_NAME);
    CAdapter cAdapter;
    EditText searchcorejava;
    ...
    void onStartMethod(){
        databaseCorejava.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                cAdapter=new CAdapter(urlsList,CoreJava.this, onListViewClick);

                Corejava_list.setAdapter(cAdapter);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Corejava_list=findViewById(R.id.list_corejava);
        fab = findViewById(R.id.addcorejava);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /*Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();*/
                Intent intent = new Intent(CoreJava.this, AddCoreJavaUrl.class);
                startActivityForResult(intent, 102);
            }
        });

        searchcorejava = findViewById(R.id.searchCorejava);
        searchcorejava.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence cs, int start, int count, int after) {
                ...
                cAdapter = new CAdapter(tempArrayList, CoreJava.this, onListViewClick);
                Corejava_list.setAdapter(cAdapter);
    ...
    public void onLisViewClick(View view, int position) {
        ...
        if (cnt >2){
            ...
            try {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(CoreJava.this);
                View layout = null;
                ...
                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(CoreJava.this, "Rating is : " + value, Toast.LENGTH_LONG).show();
                    }
                });
            ...
            Toast.makeText(CoreJava.this, "Count"+cnt, Toast.LENGTH_SHORT).show();
