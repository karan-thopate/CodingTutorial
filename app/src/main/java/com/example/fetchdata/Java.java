...
public class Java extends AppCompatActivity implements OnListViewClick{

    ImageView fab;
    ListView java_list;
    ArrayList<Url> urlsList = new ArrayList<>();
    ArrayList<Integer> arrayListCount = new ArrayList<>();
    DatabaseReference databaseCpp =  FirebaseDatabase.getInstance().getReference().child(Addjavaurl.DATBASE_NAME);
    CAdapter cAdapter;
    EditText searchjava;
    ...
    void onStartMethod(){
        databaseCpp.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                cAdapter=new CAdapter(urlsList,Java.this, onListViewClick);

                java_list.setAdapter(cAdapter);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        java_list=findViewById(R.id.list_java);
         fab = findViewById(R.id.addJava);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /*Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();*/
                Intent intent=new Intent(Java.this,Addjavaurl.class);
    ...
    searchjava=findViewById(R.id.searchJava);
        searchjava.addTextChangedListener(new TextWatcher() {
        @Override
        public void beforeTextChanged(CharSequence cs, int start, int count, int after) {
            ...
            cAdapter = new CAdapter( tempArrayList,Java.this, onListViewClick);
            java_list.setAdapter(cAdapter);
    ...
    public void onLisViewClick(View view, int position) {
        ...
        if (cnt >2){
            ...
            try {
                ...
                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(Java.this, "Rating is : " + value, Toast.LENGTH_LONG).show();
                    }
                });
            ...
            Toast.makeText(Java.this, "Count"+cnt, Toast.LENGTH_SHORT).show();
