...
public class Cpp extends AppCompatActivity implements OnListViewClick {
    ListView cpp_list;
    ImageView fab;
    ArrayList<Url> urlsList = new ArrayList<>();
    ArrayList<Integer> arrayListCount = new ArrayList<>();
    DatabaseReference databaseCpp =  FirebaseDatabase.getInstance().getReference().child(Addcppurl.DATBASE_NAME);
    CAdapter cAdapter;
    EditText searchCpp;
    ...
    void onStartMethod(){
        databaseCpp.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                cAdapter=new CAdapter(urlsList,Cpp.this, onListViewClick);

                cpp_list.setAdapter(cAdapter);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cpp_list=findViewById(R.id.list_cpp);
        fab = findViewById(R.id.addCpp);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
                Intent intent=new Intent(Cpp.this,Addcppurl.class);
        ...
        searchCpp=findViewById(R.id.searchCpp);
        searchCpp.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence cs, int start, int count, int after) {
                ...
                cAdapter = new CAdapter( tempArrayList,Cpp.this, onListViewClick);
                cpp_list.setAdapter(cAdapter);
    ...
    public void onLisViewClick(View view, int position) {
        ...
        if (cnt >2){
            ...
            try {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Cpp.this);
                View layout = null;
                ...
                builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(Cpp.this, "Rating is : " + value, Toast.LENGTH_LONG).show();
                    }
                });
            ...
            Toast.makeText(Cpp.this, "Count"+cnt, Toast.LENGTH_SHORT).show();
